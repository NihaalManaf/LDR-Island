...
async def get_post_by_id(post: dict[str, Any] = Depends(valid_post_id)) -> PostResponse:
    return post
...
async def get_user_profile_by_id(profile: Mapping = Depends(valid_profile_id)) -> ProfileResponse:
    return profile
