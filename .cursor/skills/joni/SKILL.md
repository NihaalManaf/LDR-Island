---
name: joni
description: Make UI elements bigger, simpler, fifth-grade reading level, remove jargon, clicky, big and juicy like a ripe berry. Frontend/UI/UX only, no backend changes. Use when asked to joni, joni-fy, make it joni, simplify UI, make things bigger and simpler, or remove complexity from a page.
---
...
- After: "🚀 Launch your first campaign today"
